        ...
        <div className="pt-20 pb-12 md:pt-40 md:pb-20">
          <div className="text-center">
            <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
              <span className="block">St.Joseph's Group Of Technologies</span>
              <span className="block text-indigo-600">OUR EVENTS</span>
            </h1>
            <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
              Plan, organize, and execute memorable events with our St.Joseph's Group Of Technologies.
            </p>
